...
Over the past 5+ years working as a data scientist, I have given this advice to a few of my friends and colleagues on their respective job-hunts. They've all told me that this is the most actionable and effective interview advice they've ever received, and so I'm sharing it with you as well in the hopes that it's useful for you on your journey.
...
- "So, what brings you here? Please take a few minutse to tell me a bit about your career leading up to your interview today with Metooglesoftmazon!"
...
There should be three sections: (1) Problem, (2) Solution, (3) Impact, and (4) Common Questions:
...
- Did you AB test? What were the results? What methods did you use for measuring statistical significance? Why did you use t-test? How did AB testing guide the project's next steps?
...
Like with the "Tell Me About Yourself" document, I have this one open alongside the interview video call screen. When they invariably say "tell me about a project", I deliver my "problem", "solution", and "impact" sections; then, when they invariably start grilling me with questions, I reference my "Common Questions" section:
...
Having answers to these questions prepared in clean documents simply gives you two less things to think about, and allows you to focus in your interviews on the hard questions and on building a relationship with your interviewer, the latter of which is often the most important thing. A more focused interview with a better interviewer-candidate rapport will help you to land your dream data science job faster and more effectively.
